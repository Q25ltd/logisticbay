...
export function driverProfileData(body: CreateDriverBody | PatchDriverBody) {
  ...
  return {
    ...
    ...(body.workPattern !== undefined ? { workPattern: body.workPattern ?? null } : {}),
    ...
    ...(body.basePostcode !== undefined ? { basePostcode: optionalString(body.basePostcode) ?? null } : {}),
    ...(body.baseLat !== undefined ? { baseLat: body.baseLat ?? null } : {}),
    ...(body.baseLng !== undefined ? { baseLng: body.baseLng ?? null } : {}),
